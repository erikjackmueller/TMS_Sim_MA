...
tc, areas, tri_points = sphere_mesh(1000, scaling=scaling_factor)
end = time.time()
t = t_format(end - start)
...
Q, rs, A = SCSM_tri_sphere_numba(tc, tri_points, areas, r0=r0, m=m)
Q = SCSM_jacobi_iter_debug(tc, tri_points, areas, r0=r0, m=m, tol=1e-2, A=A)
rs = tc
end = time.time()
t = t_format(end - start)
