...
Q = SCSM_jacobi_iter_cupy(tc, areas, n_v, b_im, sig_in=sigmas_in, sig_out=sigmas_out, tol=7e-17, n_iter=4,
                         omega=3e3, high_precision=True)
end = time.time()
